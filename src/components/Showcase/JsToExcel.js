...
const JsToExcelShowcase = () => {
  ...
  return (
    <section id="showcase">
      <Seo title="HTML - JS Table to Excel" />
      <div className="container d-flex flex-column justify-content-center align-items-center">
        <h3>@HAWJEH/JS-TO-EXCEL MODULE</h3>
        ...
        <button className="btn btn-primary" onClick={() => onTableClick()}>
          Export
        </button>
      </div>
    </section>
...
export default JsToExcelShowcase