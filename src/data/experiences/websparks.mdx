...
jobTitle: ".NET Team Lead / Solution Architect"
...
•	Responsible to resource screening, evaluation, interview and hiring decision

•	Customization of various content management system - Sitefinity, Sitecore

•	Setup standard git flow process and CI/CD pipeline template for the team using Azure DevOps, integrate with SAST tool such as SonarQube and Checkmarx
...
•	Develop and setup Apify with Puppeteer API to monitor web application health

•	Develop mini app using Postman API to simulate HTTP request flow and run test cases

•	Develop Google Lighthouse desktop app to run web pages quality measurement in bulk

•	Develop Teams / Telegram chatbot integrate with ChatGPT

•	Joined as .Net Developer, promoted to Senior .Net developer after 3 months’ probation, to Assistant Team lead in Jan 2019, to Team Lead in June 2021, to Solution Architect in January 2023
